...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='blog_post', verbose_name="Author")
    ...
    tags = TaggableManager()  # Из библиотеки Taggit
    ...
    object = models.Manager()  # Стандартный менеджер
    published = PublishedManager()  # Дает возможность использовать фильтр published
